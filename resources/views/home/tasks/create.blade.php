            ...
            <div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <attach-subtask :preinstaller_tasks='@json($preinstallerTasks)' :selects='@json($selects)' :old='@json(old())' :errors='@json($errors->getMessages())' :users='@json($project->team->users)'></attach-subtask>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
